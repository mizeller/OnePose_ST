...
python3 $PROJECT_DIR/demo.py +experiment="inference_demo" data_base_dir="$PROJECT_DIR/data/demo/$OBJ_NAME $OBJ_NAME-test" sfm_base_dir="$PROJECT_DIR/data/demo/$OBJ_NAME/sfm_model/outputs_softmax_loftr_loftr/$OBJ_NAME"