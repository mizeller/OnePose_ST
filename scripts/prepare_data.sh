...
root_dir="/local/home/mizeller/projects/OnePose_ST/data/spot"
...
# expected warning; rm: refusing to remove '.' or '..' directory: skipping '.'
# find $root_dir -type d ! -name '*-annotate' -exec rm -r {} +